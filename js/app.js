(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".portfolio-renovation__slider")) new core(".portfolio-renovation__slider", {
                ...
                simulateTouch: true,
                pagination: {
                    el: ".portfolio-renovation__pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".portfolio-design__slider")) new core(".portfolio-design__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 30,
                ...
                simulateTouch: true,
                pagination: {
                    el: ".portfolio-design__pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
...
***************************************************************************** */
        ...
        window.onscroll = () => {
            if (window.scrollY > 400) scrollBtn.classList.remove("showBtn-hide"); else scrollBtn.classList.add("showBtn-hide");
        };
        scrollBtn.onclick = () => {
            window.scrollTo({
                top: 0,
